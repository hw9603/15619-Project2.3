...
var CloudSearchClient_CloudSearchClient =
/*#__PURE__*/
function () {
  ...
  _createClass(CloudSearchClient, [{
    ...
    value: function () {
      ...
      /*#__PURE__*/
      regenerator__default.a.mark(function _callee(searchQuery, size) {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 4;
                return external__axios__default.a.get("/searchproxy?q=".concat(searchQuery, "&size=").concat(size, "&searchEndpoint=").concat(this.searchEndpoint));
              ...
              case 7:
                _context.next = 9;
                return external__axios__default.a.get("http://".concat(this.searchEndpoint, "/2013-01-01/search?q=").concat(searchQuery, "&size=").concat(size));
              ...
              case 12:
                ...
                console.error("Error connecting to ".concat(this.searchEndpoint));
...
function search__asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } } function _next(value) { step("next", value); } function _throw(err) { step("throw", err); } _next(); }); }; }
...
function (_React$Component) {
  ...
  search__createClass(SearchResultsView, [{
    ...
    key: "getInitialProps",
    value: function () {
      var _getInitialProps = search__asyncToGenerator(
      /*#__PURE__*/
      regenerator__default.a.mark(function _callee(ctx) {
...
/* harmony default export */ var search = __webpack_exports__["default"] = (Object(DefaultPage["a" /* default */])(search_SearchResultsView));

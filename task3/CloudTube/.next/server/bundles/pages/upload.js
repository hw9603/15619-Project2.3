...
function (_React$Component) {
  ...
  function UploadPage(props) {
    ...
    _this = _possibleConstructorReturn(this, (UploadPage.__proto__ || Object.getPrototypeOf(UploadPage)).call(this, props));
    _this.state = {
      complete: false,
      progress: 0,
      started: false,
  ...
  _createClass(UploadPage, [{
    ...
    value: function render() {
      return external__react__default.a.createElement("div", {
        ...
        width: 4
      }, external__react__default.a.createElement(external__react_no_ssr__default.a, null, external__react__default.a.createElement(external__react_s3_uploader__default.a, {
        id: "file",
        ...
        "for": "file",
        className: "clickable upload-btn"
      }, "Choose Video ", external__react__default.a.createElement(external__semantic_ui_react_["Icon"], {
        name: "cloud upload"
      })))), external__react__default.a.createElement(external__semantic_ui_react_["Grid"].Column, {
        width: 12
      }, this.state.started ? external__react__default.a.createElement(external__semantic_ui_react_["Progress"], {
        size: "big",
        percent: this.state.progress,
        color: this.state.complete ? 'olive' : 'red',
        inverted: true,
        progress: true
      }, this.state.fileName + ' - ', this.state.error ? 'Error, please refresh and try again' : this.state.complete ? 'Upload Complete' : 'Uploading Video...') : false)))));
    }
  }]);
...
function upload__typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { upload__typeof = function _typeof(obj) { return typeof obj; }; } else { upload__typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return upload__typeof(obj); }
...
function upload__defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function upload__createClass(Constructor, protoProps, staticProps) { if (protoProps) upload__defineProperties(Constructor.prototype, protoProps); if (staticProps) upload__defineProperties(Constructor, staticProps); return Constructor; }

function upload__possibleConstructorReturn(self, call) { if (call && (upload__typeof(call) === "object" || typeof call === "function")) { return call; } return upload__assertThisInitialized(self); }

function upload__assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function upload__inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }
...
function (_React$Component) {
  ...
  upload__createClass(UploadView, [{
    key: "render",
    value: function render() {
      return external__react__default.a.createElement(SingleHeaderLayout["a" /* default */], null, external__react__default.a.createElement(components_UploadPage, this.props));
    }
  }], [{
    key: "getInitialProps",
    value: function () {

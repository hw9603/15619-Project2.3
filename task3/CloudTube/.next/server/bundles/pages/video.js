...
var VideoPage_ThumbnailPreview = function ThumbnailPreview(_ref) {
  ...
  return external__react__default.a.createElement("div", {
    ...
    src: "".concat(config_default.a.STORAGE_DOMAIN, "/").concat(config_default.a.S3_ENDPOINTS[source].THUMBNAIL_BUCKET, "/").concat(thumbnail, ".png")
  }), external__react__default.a.createElement("div", {
    className: "overlay"
  }, timecode));
};

var VideoPage_VideoPage =
/*#__PURE__*/
function (_React$Component) {
  ...
  _createClass(VideoPage, [{
    ...
    value: function render() {
      ...
      return external__react__default.a.createElement("div", {
        ...
        width: 14
      }, external__react__default.a.createElement(external__semantic_ui_react_["Grid"].Row, null, external__react__default.a.createElement(external__react_no_ssr__default.a, null, external__react__default.a.createElement(external__video_react_["Player"], {
        autoPlay: true,
        ref: "player"
      }, external__react__default.a.createElement("source", {
        src: "".concat(config_default.a.STORAGE_DOMAIN, "/").concat(config_default.a.S3_ENDPOINTS[this.props.source].INPUT_BUCKET, "/").concat(this.props.slug, ".mp4")
      }), external__react__default.a.createElement(external__video_react_["ControlBar"], null, external__react__default.a.createElement(external__video_react_["CurrentTimeDisplay"], {
        order: 4.1
      }), external__react__default.a.createElement(external__video_react_["TimeDivider"], {
        order: 4.2
      }), external__react__default.a.createElement(external__video_react_["PlaybackRateMenuButton"], {
        rates: [5, 2, 1, 0.5, 0.1],
        order: 7.1
      }), external__react__default.a.createElement(external__video_react_["VolumeMenuButton"], null))))), external__react__default.a.createElement(external__semantic_ui_react_["Grid"].Row, null, external__react__default.a.createElement("br", null), external__react__default.a.createElement(external__semantic_ui_react_["Container"], {
        fluid: true
      }, external__react__default.a.createElement("p", {
        className: "ranking"
      }, "#", Object(utils["d" /* getRankFromSlug */])(this.props.slug), " ON TRENDING"), external__react__default.a.createElement("p", {
        className: "title"
      }, Object(utils["h" /* getTitleFromSlug */])(this.props.slug)), external__react__default.a.createElement("p", {
        className: "views"
      }, Object(utils["i" /* getViewsFromSlug */])(this.props.slug), " views")), this.props.timecodes.length > 0 ? external__react__default.a.createElement(external__semantic_ui_react_["Container"], {
        fluid: true,
        className: "search-labels"
      }, external__react__default.a.createElement("p", {
        className: "title"
      }, "Video Content Search Results: ", this.props.query.toUpperCase()), this.props.timecodes.map(function (timecode) {
        return external__react__default.a.createElement(VideoPage_ThumbnailPreview, {
          key: _this.props.slug + '_' + timecode,
          timecode: timecode,
          source: _this.props.source,
          thumbnail: "".concat(_this.props.slug, "_").concat(timecode),
          handleSeek: _this.handleSeek.bind(_this, timecode)
        });
      })) : false))));
    }
  }]);
...
function video__typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { video__typeof = function _typeof(obj) { return typeof obj; }; } else { video__typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return video__typeof(obj); }
...
function video__defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function video__createClass(Constructor, protoProps, staticProps) { if (protoProps) video__defineProperties(Constructor.prototype, protoProps); if (staticProps) video__defineProperties(Constructor, staticProps); return Constructor; }

function video__possibleConstructorReturn(self, call) { if (call && (video__typeof(call) === "object" || typeof call === "function")) { return call; } return video__assertThisInitialized(self); }

function video__assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function video__inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }
...
function (_React$Component) {
  ...
  video__createClass(VideoView, [{
    key: "render",
    value: function render() {
      return external__react__default.a.createElement(SingleHeaderLayout["a" /* default */], {
